    ...
    public function up()
    {
        ...
        try {
            $this->createTable('{{%oauth_clients}}', [
                ...
                'client_secret' => Schema::TYPE_STRING . '(80) DEFAULT NULL',
                'redirect_uri' => Schema::TYPE_STRING . '(2000) NOT NULL',
                'grant_types' => Schema::TYPE_STRING . '(100) DEFAULT NULL',
            ...
            $this->createTable('{{%oauth_authorization_codes}}', [
                ...
                'client_id' => Schema::TYPE_STRING . '(80) NOT NULL',
                'user_id' => Schema::TYPE_BIGINT . ' DEFAULT NULL',
                'redirect_uri' => Schema::TYPE_STRING . '(2000) DEFAULT NULL',
                'expires' => Schema::TYPE_TIMESTAMP . ' NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP',
                'scope' => Schema::TYPE_STRING . '(2000) DEFAULT NULL',
            ...
            $this->batchInsert('{{%oauth_clients}}', ['client_id', 'client_secret', 'redirect_uri', 'grant_types'], [
                ['testclient', 'testpass', 'http://locahost/', 'client_credentials authorization_code password implicit'],
            ]);
